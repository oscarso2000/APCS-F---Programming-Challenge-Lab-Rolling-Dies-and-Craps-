  ...
  private void drawDots(Graphics g, int x, int y, int numDots)
  {
    ...
    switch (numDots)
    {
      ...
      case 3:
        ...
        g.fillOval(x1,y1,dotSize,dotSize);
        g.fillOval(x3,y3,dotSize,dotSize);
        g.fillOval(x1,y1+(dieSize/2),dotSize,dotSize);
        g.fillOval(x3,y3-(dieSize/2),dotSize,dotSize);
        break;
        case 5: 
        g.fillOval(x1,y1,dotSize,dotSize);
        g.fillOval(x3,y3,dotSize,dotSize);
        ...
        g.fillOval(x1,y1+(dieSize/2),dotSize,dotSize);
        g.fillOval(x3,y3-(dieSize/2),dotSize,dotSize);
        g.fillOval(x1,y1+(dieSize/4),dotSize,dotSize);
        g.fillOval(x3,y3-(dieSize/4),dotSize,dotSize);
        break;
    }
  }
}
